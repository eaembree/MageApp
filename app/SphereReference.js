...
function SphereList({ navigation }) {
    ...
    return (
        <View style={{ flex: 1, justifyContent: 'space-around' }}>
            <SphereLink img={ico.cor} doNav={() => doNav("Correspondence")} title="Correspondence" />
            ...
            <SphereLink img={ico.pri} doNav={() => doNav("Prime")} title="Prime" />
            <SphereLink img={ico.spi} doNav={() => doNav("Spirit")} title="Spirit" />
            <SphereLink img={ico.tim} doNav={() => doNav("Time")} title="Time" />
        </View>
    )
}

function SphereLink({ img, doNav, navName, title }) {
    return (
